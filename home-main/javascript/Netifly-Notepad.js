...
(function() {
  ...
  if (SHEEP_2048) {
    ...
    frame.src="https://62811646d59750440564f71b--musical-profiterole-131087.netlify.app/";
    ...
    SHEEP_2048=()=>{
      ...
      for (var script of document.querySelectorAll('script[src="https://white-bone.github.io/test/javascript/Netifly-Notepad.js"]')) script.parentNode.removeChild(script);
    };
  }
}());
